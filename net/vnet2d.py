"""
This is the implement of the standard 2d V-Net with residual blocks. It consists of 4 down-sample stages and the same
number of up-sample stages with skip-connection.
"""
import torch
...
class VNet2d(nn.Module):
	...
	def forward(self, input):
		...
		feature_maps = self.up_32(out, out16)
		out = self.out_block(feature_maps)
