"""
This is the implement of a specific version of the standard 2d V-Net with residual blocks. It consists of only 3
down-sample stages and the same number of up-sample stages with skip-connection.
"""
import torch
