...
# general parameters
__C.general = {}
__C.general.data_root_dir = '/data1/minqing/data/segTHOR/padded-data-split-4/'
__C.general.saving_dir = '/data1/minqing/models/20200219_segTHOR_dataset4_clean_segmentation_CE_default/'
...
__C.dataset.cropping_size = [224, 224]  # [H, W] (pixel)
