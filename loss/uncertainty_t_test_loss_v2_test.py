...
def TestUncertaintyTTestLossV2(args):
    for i in range(args.num_test):
        loss_func = UncertaintyTTestLossV2(args.beta, args.lambda_p, args.lambda_n, args.uncertainty_threshold)
...
if __name__ == '__main__':
    ...
    TestUncertaintyTTestLossV2(args)
